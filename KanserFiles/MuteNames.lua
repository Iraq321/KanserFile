...
if DevAli:get(Kanser.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(Kanser.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(Kanser.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
KanserName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if KanserName then 
KanserNames = DevAli:smembers(Kanser.."Ali:Mute:Names"..msg.chat_id_) or ""
if KanserNames and KanserNames[1] then 
for i=1,#KanserNames do 
if KanserName:match("(.*)("..KanserNames[i]..")(.*)") then 
...
DevAli:set(Kanser.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(Kanser.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
